...
<head>
    ...
    <style>
        ...
        .card { border-radius: 12px; overflow:hidden; max-width:900px; margin:40px auto; }
        ...
        <div class="row g-0">
            <div class="col-md-4 profile-side">
                <div style="text-align:center;">
                    <i class="fas fa-user-cog" style="font-size:48px;color:#ff9900"></i>
                    <h4 style="margin-top:12px;">Edit User</h4>
                    <p style="opacity:.85;">ID: {{ $user->id }}</p>
                </div>
            </div>
            <div class="col-md-8">
                <div class="p-4">
                    ...
                    <form action="{{ route('users.update', $user->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="street_name" class="form-control" value="{{ old('street_name', $user->street_name) }}">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Building Name / Number</label>
                            <input type="text" name="building_name" class="form-control" value="{{ old('building_name', $user->building_name) }}">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Floor / Apartment Number <span style="font-size:0.85rem; color:#999;">(Optional)</span></label>
                            <input type="text" name="floor_apartment" class="form-control" value="{{ old('floor_apartment', $user->floor_apartment) }}">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Landmark <span style="font-size:0.85rem; color:#999;">(Optional)</span></label>
                            <input type="text" name="landmark" class="form-control" value="{{ old('landmark', $user->landmark) }}">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">City / Area</label>
                            <input type="text" name="city_area" class="form-control" value="{{ old('city_area', $user->city_area) }}">
                        </div>
